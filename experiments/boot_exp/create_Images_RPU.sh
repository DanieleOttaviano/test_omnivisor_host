...
SRC_RPU_BOOT_DIR="${JAILHOUSE_DIR}/inmates/demos/armr5/src_boot"
...
OUTPUT_BIN_DIR="${TEST_OMNV_GUEST_DIR}/experiments/boot_exp/inmates/RPU"
...
rm -rf ${SRC_RPU_DIR}/*
cp ${SRC_RPU_BOOT_DIR}/* ${SRC_RPU_DIR}
